            ...
            <tr>
              ...
              <td className="total separator">{`${
                !facturaObject.totalDocumento.subTotal05
                  ? "0"
                  : toPoint(Math.floor(facturaObject.totalDocumento.subTotal05))
              }`}</td>
              <td className="total separator">{`${
                !facturaObject.totalDocumento.subTotal10
                  ? 0
                  : toPoint(Math.floor(facturaObject.totalDocumento.subTotal10))
              }`}</td>
            </tr>
      ...
      <div className="footer-container">
        ...
        <div>
          <blockquote className="leyenda-qr">
            ...
            impreso abajo en https://ekuatia.set.gov.py/consultas
          </blockquote>
